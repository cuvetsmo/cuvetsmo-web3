...
export const TEMPLATES: TemplateMeta[] = [
  {
    ...
    emoji: "🎰",
    description:
      "ผู้เข้าร่วมจ่ายค่าธรรมเนียมเข้าจับฉลาก แล้ว owner เรียก draw() สุ่มผู้ชนะรับ pot",
  ...
  },
  {
    ...
    emoji: "🫙",
    description:
      "รับ tip เป็น ETH พร้อมข้อความ ใครก็ส่งได้ owner กด withdraw รวมไปที่กระเป๋า",
  ...
  },
  {
    ...
    emoji: "📅",
    description:
      "Lock token แล้วปล่อยตามเวลา linear (มี cliff ได้) — 1 contract = 1 beneficiary",
    useCase: "ค่อยๆ ปล่อย team token, grant สำหรับ contributor",
  ...
  },
  {
    ...
    emoji: "💧",
    description:
      "Sender ส่ง ETH แบบไหลตามเวลาให้ recipient — recipient withdraw ได้ตลอด, skeleton ยังไม่รองรับ cancel",
